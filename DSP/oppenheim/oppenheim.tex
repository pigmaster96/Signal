...
\end{equation*}
The response value at a specific time $n$ of a linear system is the superposition of the `contributions' to that point from each impulse response (from all points in time).\\
(next page)\newpage
...
that every impulse response could contribute to a particular output point in time, thus the limits $-\infty$ to $\infty$)\\
(next page)\newpage
